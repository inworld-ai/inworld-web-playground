...
async function run() {
  ...
  const ASSETS_ZIP_FILENAME = `inworld-web-playground-assets-${ASSETS_VERSION}.zip`;
  ...
  try {
    console.log(
      'Running Inworld Web Gallery Assets Installer. Asset Library:',
      ASSETS_VERSION,
    );
    let pass = false;
